...
{
public:
	UIRenderer(donut::app::DeviceManager* deviceManager, std::shared_ptr<MeshShadersApp> aApp);

protected:
	virtual void BuildUI(void) override;

private:
	std::shared_ptr<MeshShadersApp> mInitApp;
};
...
class MeshShadersApp : public donut::app::ApplicationBase
{
public:
